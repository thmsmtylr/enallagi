...
# __HARNESS_DIR__/tasks.py; this file is the shell surface over it and holds no parser of its own.
#
...
tasks() { python3 __HARNESS_DIR__/tasks.py "$@" "${TASKS_FILE:-TASKS.md}"; }
