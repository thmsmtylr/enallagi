...
| `criteria:` | must be runnable by an agent that has read only the context file, the spec, __HARNESS_DIR__/LEARNINGS.md and this block. Criteria assuming conversational context are unrunnable. |
