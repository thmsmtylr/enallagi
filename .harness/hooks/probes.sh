...
SOURCE_EXT = tuple([".sh", ".py", ".md", ".json"])
errors = 0
...
DOCS = set([".check-baseline", "AGENTS.md", "CLAUDE.md", "DECISIONS.md", "GEMINI.md", "LEARNINGS.md", "PROGRESS.archive.md", "PROGRESS.md", "README.md", "SPEC.md", "TASKS.md", "harness.default.json", "harness.json", "test-hashes.json"])
