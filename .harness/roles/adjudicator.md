...
2. **Re-run the command yourself** and paste what you got. Do not trust the pasted output, and do not trust a cached green: the uncached form is `./selftest.sh`. If your run does not emit that `FINDING` line, the finding does not reproduce → kill, quoting your run.
